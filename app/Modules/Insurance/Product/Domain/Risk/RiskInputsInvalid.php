 ...
 * Follow-up H2: `schema` is the schema that refused them, so a screen can name each field by its label (App\Http\Feedback\RiskProblems).
 */
final class RiskInputsInvalid extends BusinessRuleViolation
{
    /** @param array<string, string> $errors field key → problem code */
    public function __construct(public readonly array $errors, public readonly ?RiskSchema $schema = null)
    {
