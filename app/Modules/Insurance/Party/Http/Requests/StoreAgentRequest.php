...
final class StoreAgentRequest extends FormRequest
{
    ...
    {
        return [
            'party_id' => ['required', 'uuid', Rule::exists('parties', 'id'), Rule::unique('agents', 'party_id')],
            'code' => ['required', 'string', 'max:32', Rule::unique('agents', 'code')],
            'branch_id' => ['required', 'uuid', Rule::exists('branches', 'id')],
            'parent_agent_id' => ['nullable', 'uuid', Rule::exists('agents', 'id')],
