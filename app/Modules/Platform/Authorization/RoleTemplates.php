...
final class RoleTemplates
{
    ...
    private const BRANCH_OFFICER = ['policy.create', 'policy.issue', 'receipt.create'];
    ...
    private const FINANCE_MANAGER_EXTRA = ['accounting.approve_journal', 'accounting.reverse_journal', 'periods.soft_lock', 'periods.lock',
        'commission.approve', 'claim.pay_release', 'receipt.refund_release'];
    ...
    public static function all(): array
    {
        ...
        return [
            ...
            'branch_manager' => ['name' => 'Branch Manager', 'permissions' => [...self::BRANCH_OFFICER, 'policy.cancel', 'receipt.allocate', 'claim.register']],
            'claims_officer' => ['name' => 'Claims Officer', 'permissions' => self::CLAIMS_OFFICER],
            'claims_manager' => ['name' => 'Claims Manager', 'permissions' => [...self::CLAIMS_OFFICER, 'claim.approve', 'claim.pay_request']],
