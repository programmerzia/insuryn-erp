...
Route::middleware('auth')->group(function (): void {
    ...
    Route::post('policies/{policy}/endorse-details', [PolicyPageController::class, 'endorseDetails'])->whereUuid('policy'); // gap fixes W7 (GA-25): no premium change, posts nothing
