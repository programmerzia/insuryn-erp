...
final class PartADemoSeeder extends Seeder
{
    ...
    private function story(array $accounts): void
    {
        ...
        (new FinanceModulesDemoSeeder())->beforeAugustClose($this->entityId, $this->branchId, $this->secondBranchId, $this->bankAccountId, $this->users); // design addendum v2 §B.6–B.8
