...
withDefaults(defineProps<{ title: string; width?: string }>(), { width: 'w-[440px]' });
...
<template>
    <DialogRoot v-model:open="open">
        <DialogPortal>
            ...
            <DialogContent class="fixed inset-y-0 right-0 z-50 flex max-w-full flex-col border-l border-line bg-surface text-ink shadow-float outline-none" :class="width" :aria-describedby="undefined">
